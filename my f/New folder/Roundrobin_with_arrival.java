class Roundrobin_with_arrival{
    static void findWaitingTime(int processes[],int at[],int n,int bt[],int wt[],int quantam){
    ...
    static void findAvgTime(int processes[],int n,int bt[],int quantam,int at[]){
        int wt[]=new int[n];
        int tat[]=new int[n];
        int total_wt=0,total_tat=0;
        findWaitingTime(processes,at,n,bt,wt,quantam);
        ...
        for (int i=0;i<n;i++){
            total_wt += wt[i];
            total_tat += tat[i];
            System.out.print("| P"+processes[i]+"     |       "+bt[i]+"      |      "+at[i]+"       |      "+wt[i]+"    |      " +tat[i]+"        |     "+"\n");
        }
            System.out.println("---------------------------------------------------------");
    ...
    public static void main(String[] args){
        ...
        int quantam=5;
        findAvgTime(processes,n,burst_time,quantam,at);
    }
}